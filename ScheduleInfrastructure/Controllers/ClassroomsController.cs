...
namespace ScheduleInfrastructure.Controllers
{
    public class ClassroomsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,RoomNumber")] Classroom classroom)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,RoomNumber")] Classroom classroom)
        {
            if (id != classroom.Id)
            {
                return NotFound();
